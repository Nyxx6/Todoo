...
<html>
	...
	<body>
		<div class="login-header box-shadow">
			...
			>
				...
				<div class="justify-content-between">      			  	
      			  <span class="text" id="slogan" style="font-family:Roboto;font-weight:600;font-size:20px;color:red">Be your time master</span>
 			    </div>
							...
							<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
								<div class="form-group">
									...
									<input
										...
										name="email"
										id="em"
										onkeyup="validat(un.value,p1.value,p2.value,em.value)"
									/>
								</div>
								<div class="form-group ">
								...
								<div class="row align-items-center">
									<div class="col-sm-12">
										<div class="input-group mb-0">
											<input class="btn btn-primary btn-lg btn-block" name="submit" type="submit" value="Submit" id="sub">																				
										</div>
									</div>
								</div>
							</form>
		...
		<script>
			$("#slogan").hover(()=>{
				$("#slogan").css("font-size","2em")				
			});
			$("#slogan").mouseout(()=>{
				$("#slogan").css("font-size","1.5em")				
			});
		</script>
	</body>
</html>
