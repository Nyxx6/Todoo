		...
		<div class="login-header box-shadow">
			<div
				...
				<div class="justify-content-between">
      			  	<span class="text" style="font-family:Roboto;font-weight:600;font-size:20px;color:red">Be your time master</span>
 			    </div>
					...
					<div class="col-md-6 col-lg-5">
						<div class="login-box box-shadow border-radius-10">
							...
							<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
								...
								<small class="form-text text-muted" id="errun" style="color:red"><?php echo $err['username'] ?? ''  ?>
									Username not valid
								</small>
								<!--role-->
								<div class="input-group custom">
									<input
										...
										name="username" id="un" onkeyup="validate(un.value,ps.value)"
									/>
								...
								<small class="form-text text-muted" id="errps" style="color:red"><?php echo $err['password'] ?? ''  ?>
								...
								<div class="input-group custom">
									<input
										...
										class="form-control form-control-lg"
										placeholder="********"
										name="password" id="ps" onkeyup="validate(un.value,ps.value)"
									/>
									<div class="input-group-append custom">
										<span class="input-group-text"
